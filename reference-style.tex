...
\ExecuteBibliographyOptions{maxbibnames=6,minbibnames=6}%In the bibliography, the first six authors are listed, then et al.
\ExecuteBibliographyOptions{maxcitenames=2}%In-text, two authors are listed in full, three or more are first author then et al.
...
%Ensure all names are ordered last-first. Editors aren't, otherwise.
