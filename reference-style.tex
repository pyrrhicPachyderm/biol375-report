...
\ExecuteBibliographyOptions{maxbibnames=6,minbibnames=3} %In the bibliography, the first maxnames authors are listed, then the list is truncated to minnames
%TODO: maxbibnames=10,minbibnames=10 if using official style
...
%TODO: Remove for official style
