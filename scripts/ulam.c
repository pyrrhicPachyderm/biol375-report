...
long long unsigned int ulamIdentityDistance(const int *a, size_t length) {
	return 0;
}
...
long long unsigned int ulamHausdorffDistance(const int *a, const int *b, size_t length, size_t numRanks) {
	return 0;
}
