...
%TODO: Some level of standardisation on whether we are talking about stability or about disturbance.
...
%TODO: Summarise the shift in community composition. Binomial regression on shells?
...
Our result implies that either both mechanisms (homogenisation due to species sorting and diversification due to stochastic colonisation) were acting in opposition to one another, or that neither is acting particularly strongly.
Considering that there were several species present only the stable streams, species sorting probably was occurring, and hence both mechanisms were probably in force.
