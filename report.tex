...
To plot and ordination, and to assess differences in community composition and community dispersion ($\beta$-diversity), was calculated a distance metric between each pair of sites.
To make full use of the collected semi-quantitative (ordinal, partially ranked) data, we use the Hausdorff extension of Ulam's metric, as developed by \textcite{Critchlow} and recommended by \textcite{dissimilarity-partially-ranked}.
