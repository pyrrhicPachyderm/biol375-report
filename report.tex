...
There was a significant decrease in the proportion of shelled macroinvertebrates with increasing Pfankuch score (\inputresults{taxa-abundance-shelled}; Figure \ref{fig:shell-abundance-regression}).
...
%TODO: Note that Proportion is not a true proportion: coded abundance. Pattern clear nonetheless.
